...
CREATE TABLE PET_C_VENTA.CATALOGO_CATEGORIA(
    ...
    CONSTRAINT CATALOGO_CATEGORIA_PK PRIMARY KEY (CATALOGO_CATEGORIA_ID) USING INDEX TABLESPACE VENTA_IDXS_TS
) TABLESPACE VENTA_TS ;
...
CREATE TABLE PET_C_VENTA.CATALOGO_PRODUCTO(
    ...
    CONSTRAINT CATALOGO_PRODUCTO_PK PRIMARY KEY (CATALOGO_PRODUCTO_ID)  USING INDEX TABLESPACE VENTA_IDXS_TS
) TABLESPACE VENTA_TS 
;
...
CREATE TABLE PET_C_VENTA.CLIENTE(
    ...
    CONSTRAINT CLIENTE_PK PRIMARY KEY (CLIENTE_ID) USING INDEX TABLESPACE VENTA_IDXS_TS
) TABLESPACE VENTA_TS ;
...
CREATE TABLE PET_C_VENTA.PRODUCTO_CATEGORIA(
    ...
    FECHA                    DATE             NOT NULL,
    CONSTRAINT PRODUCTO_CATEGORIA_PK PRIMARY KEY (PRODUCTO_CATEGORIA_ID) USING INDEX TABLESPACE VENTA_IDXS_TS,
    CONSTRAINT CAT_PROD_PROD_CAT_CAT_PROD_ID_FK  
    FOREIGN KEY (CATALOGO_PRODUCTO_ID)
    REFERENCES PET_C_VENTA.CATALOGO_PRODUCTO(CATALOGO_PRODUCTO_ID),
    CONSTRAINT CAT_CATE_PROD_CAT_ID_FK  FOREIGN KEY (CATALOGO_CATEGORIA_ID)
    REFERENCES PET_C_VENTA.CATALOGO_CATEGORIA(CATALOGO_CATEGORIA_ID)
) TABLESPACE VENTA_TS ;
...
CREATE TABLE PET_C_VENTA.CLIENTE_TELEFONO(
    ...
    USING INDEX TABLESPACE VENTA_IDXS_TS,
    CONSTRAINT CLIENTE_CLIENTE_TELEFONO_CLIENTE_ID_FK  FOREIGN KEY (CLIENTE_ID)
    REFERENCES PET_C_VENTA.CLIENTE(CLIENTE_ID)
) TABLESPACE VENTA_TS ;
...
CREATE TABLE PET_C_VENTA.SERVICIO_ORDEN_COMPRA(
    ...
    REFERENCES PET_C_VENTA.ORDEN_COMPRA(ORDEN_COMPRA_ID)  
) TABLESPACE VENTA_TS ;
...
CREATE TABLE PET_C_VENTA.ESTATUS_INVENTARIO_HISTORICO(
    ...
    REFERENCES PET_C_VENTA.ESTATUS_PRODUCTO(ESTATUS_PRODUCTO_ID),
    CONSTRAINT EST_INV_HIS_INV_PROD_ID_FK  FOREIGN KEY (INVENTARIO_PRODUCTO_ID)
    REFERENCES PET_C_VENTA.INVENTARIO_PRODUCTO(INVENTARIO_PRODUCTO_ID)
) TABLESPACE VENTA_TS;
